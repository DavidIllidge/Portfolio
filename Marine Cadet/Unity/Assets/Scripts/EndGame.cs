...
public class EndGame : BaseMenuState 
{
	...
	public string FishRemaining;
	public GUIText GUIFishRemaining;
		...
		
	{
		if (endGame == true)
		{
			FishRemaining = GUIFishRemaining.text;
